...
def init_db():
    ...
    if not (groq_client.get_candles(symbol='ETHUSDT', timeframe='1h') or groq_client.get_candles(symbol='BTCUSDT', timeframe='1h') or groq_client.get_candles(symbol='BNBUSDT', timeframe='5m')):
