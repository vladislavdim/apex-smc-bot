...
STATS_BASELINE_UTC = datetime.fromisoformat("2026-09-03T11:03:20+00:00")  # PR #95 live on Render
...
def build_dashboard(days: int = 1, strategy: str = "", symbol: str = "", outcome: str = "", groq: str = "",
    ...
    return {"period_days":days,"baseline":"post95","baseline_utc":STATS_BASELINE_UTC.isoformat(),"generated_at":datetime.now(timezone.utc).isoformat(timespec="seconds"),
...
</style></head><body><main><div class=top><div><div class=title>📊 APEX · Strategy Lab</div><div class=muted>Актуальная статистика после #95 · с 11:03:20 UTC 03.09.2026</div></div><div id=updated class=muted></div></div>
