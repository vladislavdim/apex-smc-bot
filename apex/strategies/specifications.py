...
STRATEGY_CATALOG: dict[str, dict[str, Any]] = {
    "FAST": {
        ...
        "criteria": [
            ...
            _c("fast_engulfing_volume", "Trigger", "Engulfing volume ≥ 1.6× 15m average"),
    ...
    "MTF": {
        ...
        "criteria": [
            ...
            _c("mtf_rr", "Geometry", "RR is at least 2.0; no upper ceiling"),
    ...
    "SWING": {
        ...
        "criteria": [
            ...
            _c("swing_rr_detector", "Geometry", "Detector prefilter is 1.5 (1.8 off-hours); final Signal Integrity requires 2.0"),
            ...
            _c("swing_integrity", "Final deterministic gate", "Signal Integrity enforces min RR 2.0"),
    ...
    "WYCKOFF": {
        ...
        "rr": "Final Signal Integrity min 2.0; subtype/Groq quality checks may be stricter",
        ...
        "criteria": [
            ...
            _c("wy_integrity", "Final deterministic gate", "Signal Integrity validates levels and min RR 2.0"),
...
__all__ = [
    "SPECIFICATIONS", "STRATEGY_CATALOG", "StrategySpecification",
    "catalog_payload", "specification_for",
]
