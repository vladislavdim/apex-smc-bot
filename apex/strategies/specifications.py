...
SPECIFICATIONS: Mapping[Strategy, StrategySpecification] = {
    ...
    Strategy.MTF: StrategySpecification(Strategy.MTF, "15m", ("1h", "4h", "1d"), ("htf_thesis",), ("fresh_15m_bos_choch",), ("ob_or_fvg", "premium_discount"), ("structural_sl", "structural_target", "rr_gte_2"), "15m"),
    ...
    Strategy.SWING: StrategySpecification(Strategy.SWING, "15m", ("1h", "4h", "1d"), ("4h_thesis",), ("fresh_1h_structure", "15m_execution"), ("htf_ob_or_fvg",), ("structural_sl", "structural_target", "rr_gte_2"), "1h"),
    Strategy.WYCKOFF: StrategySpecification(Strategy.WYCKOFF, "4h", ("1d",), ("phase", "range", "volume_behavior"), ("spring_sos_or_utad_sow",), ("creek_ice",), ("structural_sl", "structural_target", "rr_gte_2"), "1h"),
}
